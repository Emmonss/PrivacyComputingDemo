...
import transfer.grpc_trans.proto.mytransfer_pb2 as mytransfer__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in mytransfer_pb2_grpc.py depends on'
...
class TransferService(object):
    ...
    def send_data(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/TransferService/send_data',
            mytransfer__pb2.Data.SerializeToString,
