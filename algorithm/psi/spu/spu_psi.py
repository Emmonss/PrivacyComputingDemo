    ...
    def test_pir(self):
        ...
        {{
            ...
            "pir_server_config": {{
                ...
                "setup_path": "./output/spu_test_pir_pir_server_setup",
                "key_columns": [
                    "id"
                ],
                "label_columns": [
                ...
                "bucket_size": 1000000,
                "apsi_server_config": {{
                    "oprf_key_path": "./output/spu_test_pir_server_secret_key.bin",
                    "num_per_query": 1,
                    "compressed": false
                }}
            }}
        ...
        {{
            ...
            "pir_protocol": "PIR_PROTOCOL_KEYWORD_PIR_APSI",
            "pir_client_config": {{
                "input_path": "./output/spu_test_pir_pir_client.csv",
                "key_columns": ["id"],
                "output_path": "./output/spu_test_pir_pir_output.csv"
            }}
        }}
        '''
        ...
        jobs = [multiprocess.Process(target=wrap,args=(rank, link_desc, configs),)for rank in range(2)]
